...
def moveToMenu():
    ...
    pyautogui.moveTo(menuPos.left + int(random.random() * 15),
...
def scrollDownVidsList():
    print("scroll down")
    menuPos = pyautogui.locateOnScreen("assets/menu.png")
    pyautogui.moveTo(menuPos.left + int(random.random() * 100),
...
def closeSingleQuiz():
    ...
    pyautogui.click(closeBox.left, closeBox.top, duration=moveDuration(), tween=pyautogui.easeInOutQuad)

def startPlayVideo():
    pyautogui.click(random.randint(300, 900),
